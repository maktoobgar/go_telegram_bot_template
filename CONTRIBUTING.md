# Welcome to go_telegram_template contributing guide
...
1. **Bug**: If you spot a problem with a certain release or a problem in develop branch, search if the [issue already exists](https://github.com/maktoobgar/go_telegram_template/issues). If a related issue doesn't exist, you can open a new issue using **Bug Report** form in [issue form](https://github.com/maktoobgar/go_telegram_template/issues/new/choose) section.
2. **Feature**: If you want to add a new functionality to the project, first look up in [issues](https://github.com/maktoobgar/go_telegram_template/issues) and if a duplicate issue does not already exist, that means possibly (Take a look at [Picking An Issue](#picking-an-issue)) no one is working on it and you can create a **Feature Issue** from [issue form](https://github.com/maktoobgar/go_telegram_template/issues/new/choose) section.
...
If there is an issue in [issues](https://github.com/maktoobgar/go_telegram_template/issues) section that interests you, look up in issue description or comments if any one got the job and if not, you can write in the comments which you are working on it and that issue is yours for about a week after that.
